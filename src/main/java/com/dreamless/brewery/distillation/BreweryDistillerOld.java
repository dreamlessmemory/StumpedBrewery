...
@Deprecated
public class BreweryDistillerOld implements InventoryHolder {
	
	public static ArrayList<BreweryDistillerOld> distillers = new ArrayList<BreweryDistillerOld>();
	public static HashMap<BreweryDistillerOld, Integer> runningDistillers = new HashMap<BreweryDistillerOld, Integer>();
	...
	public BreweryDistillerOld(Block block) {
		this.block = block;
	...
	//Static methods
	public static BreweryDistillerOld get(Block block) {
		for (BreweryDistillerOld distiller : distillers) {
	...
	public static void add(BreweryDistillerOld distiller) {
		distillers.add(distiller);
	}
	
	public static void remove(Block block) {
		BreweryDistillerOld distiller = get(block);
		if (distiller != null) {
	...
	public static class DistillerRunnable extends BukkitRunnable {
		...
		private BreweryDistillerOld distiller;
		
		public DistillerRunnable(int cycleLength, BreweryDistillerOld distiller) {
